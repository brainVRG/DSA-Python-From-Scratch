...
class RBTree:
    ...
    def insert(self, val):
        """Standard BST insertion followed by RB-Tree balancing via fix_insert."""
        new_node = RBNode(val)
    ...
    def fix_insert(self, new_node):
        """Maintains Red-Black properties by recoloring and rotating after an insertion."""
        while new_node is not self.root and new_node.parent.red:
            ...
            else: # parent is grandparent.left
