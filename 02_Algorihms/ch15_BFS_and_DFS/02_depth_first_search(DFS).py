class Graph:
    def depth_first_search(self, start_vertex):
        """Initializes the visited list and starts the recursive depth-first search."""
        visited = []
        self.depth_first_search_r(visited, start_vertex)
        return visited

    def depth_first_search_r(self, visited, current_vertex):
        """Recursively visits nodes, exploring as far as possible along each branch before backtracking."""
        visited.append(current_vertex)
        neighbors = sorted(list(self.graph[current_vertex]))
